<x-admin-layout>
    ...
    <div class="mb-8">
        ...
        <p class="text-sm text-gray-500 mt-1">Here is a quick overview of your landing page assets and configurations.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col justify-between hover:shadow-md transition-shadow">
            <div>
                ...
                <h2 class="text-xl font-bold text-gray-900">Contact Submissions</h2>
                <p class="text-gray-500 text-sm mt-2 leading-relaxed">
                    View, read, and manage customer messages and leads captured through your landing page contact form.
                </p>
            </div>

            <div class="mt-6 pt-4 border-t border-gray-50 flex items-center justify-between">
                <span class="text-xs text-slate-400 font-medium uppercase tracking-wider">Leads Engine</span>
                <a href="{{ route('admin.contact') }}" class="inline-flex items-center gap-1 text-sm font-semibold text-indigo-600 hover:text-indigo-700 transition-colors">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <div class="mt-6 pt-4 border-t border-gray-50 flex items-center justify-between">
                ...
                <a href="{{route('admin.content')}}" class="inline-flex items-center gap-1 text-sm font-semibold text-amber-600 hover:text-amber-700 transition-colors">
                    Manage Blogs &rarr;
                </a>
            </div>
        </div>
